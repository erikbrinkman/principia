...
class LinePlot {
    ...
    xaxis({ label = this._xLabel, labelBelow = this._xLabelBelow, ticks = this._xTicks, tickPadding = this._xTickPadding, format = this._xTickFormat }) {
        this._xLabel = label;
    ...
    yaxis({ label = this._yLabel, ticks = this._yTicks, tickPadding = this._yTickPadding, format = this._yTickFormat }) {
        this._yLabel = label;
        this._yTicks = ticks;
    ...
    labels({ buffer = this._labelBuffer }) {
...
class Bar extends BarPlotElement {
    ...
    plot(elem, x, y, barWidth, labelPadding, showNums, numPadding, numFormat) {
...
class Section extends BarPlotElement {
    ...
    plot(elem, _x, y, _barWidth, labelPadding, _showNums, _numPadding, _numFormat) {
